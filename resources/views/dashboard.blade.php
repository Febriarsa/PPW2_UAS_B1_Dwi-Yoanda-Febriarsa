                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4>
                                <span class="badge text-bg-secondary">{{ number_format($transaksi_count, 0, '.', '.') }}</span>
                            </h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4>
                                <span class="badge text-bg-secondary">{{ number_format($item_count, 0, '.', '.') }}</span>
                            </h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4>
                                <span class="badge text-bg-secondary">Rp {{ number_format($omzet, 0, '.', '.') }}</span>
                            </h4>
                        </div>
                    </div>
                </div>
